...
//go:generate mockgen -destination=../infrastructure/mocks/jwt_manager_mock.go -package=mocks real-time-activity-feed/internal/module/auth/application JWTManager

import (
	"context"
	"fmt"

	"real-time-activity-feed/internal/module/auth/domain"
	"real-time-activity-feed/internal/shared/logger"

	"golang.org/x/crypto/bcrypt"
)

//go:generate mockgen -destination=../adapters/mocks/auth_usecase_mock.go -package=mocks real-time-activity-feed/internal/module/auth/application AuthUseCase
