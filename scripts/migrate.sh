...
DB_URL="${DB_URL:-postgres://postgres:postgres@localhost:5432/activity_feed?sslmode=disable}"
...
show_usage() {
    ...
    echo "  DB_URL       Database connection string (default: postgres://postgres:postgres@localhost:5432/activity_feed?sslmode=disable)"
    exit 1
}
